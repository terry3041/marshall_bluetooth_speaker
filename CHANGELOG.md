...
### Changed
- Removed the `_ensure_services` method from `MarshallBleClient` (service discovery is now handled automatically by bleak).
- Updated manifest version to 0.2.1.

### Fixed
- Improved BLE client compatibility with latest bleak API.
